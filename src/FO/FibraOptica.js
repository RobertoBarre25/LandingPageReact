...
const App = () => {
    ...
    const images = [
        {
            src: 'https://vlm-production-dam-public.fra1.cdn.digitaloceanspaces.com/1366x910/b45/b456a410-9a64-496e-af02-ab1a4d8e7d6a.webp',
            alt: 'AntivirusCloud',
        ...
        <div>
            ...
            <div className="px-4 md:px-8 lg:px-12 w-full py-12 bg-beige">
                <div className="text-center mb-12">
                    <h3 className="text-7xl font-semibold mb-4 text-blue-500">Fibra Optica</h3>
                </div>
