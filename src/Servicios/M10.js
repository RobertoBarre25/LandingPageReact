...
const M10 = () => {
    ...
    const handleUpdateSection = async (event) => {
        ...
        try {
            await axios.put('http://localhost:5000/api/m10/update-by-tag', {
                ...selectedSection,
                tag: mainTag
            }, {
                headers: {
            ...
            handleModalClose();
            const response = await axios.get('http://localhost:5000/api/m10');
            setCarouselData(response.data);
        } catch (error) {
    ...
    const handleUpdateCard = async (event) => {
        ...
        try {
            await axios.put('http://localhost:5000/api/m10/update-by-tag-cards', {
                tag: mainTag,
