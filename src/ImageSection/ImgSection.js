          ...
          <div className="w-full sm:w-1/2 lg:w-1/3 mb-8">
            <div className="relative w-full h-64"> 
              ...
              <div className="absolute inset-0 bg-black opacity-75 transition-opacity duration-500 flex items-center justify-center opacity-0 hover:opacity-90">
                <div className="text-white text-center text-xl">Construyendo puentes digitales para un mundo más conectado</div>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/3 mb-8">
            <div className="relative w-full h-64"> 
              ...
              <div className="absolute inset-0 bg-black opacity-75 transition-opacity duration-500 flex items-center justify-center opacity-0 hover:opacity-90">
                <div className="text-white text-center text-xl">Servicios de consultoría en tecnología: expertos que guían tu éxito.</div>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/3 mb-8">
            <div className="relative w-full h-64"> 
              ...
              <div className="absolute inset-0 bg-black opacity-75 transition-opacity duration-500 flex items-center justify-center opacity-0 hover:opacity-90">
                <div className="text-white text-center text-xl">Innovación tecnológica para potenciar tu empresa. ¡Descubre nuestras soluciones hoy!</div>
              </div>
            </div>
          </div>
        </div>
